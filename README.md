...
> [!NOTE]
> ♟️ **Proyecto paralelo:** Hace poco también implementé **[Chess Study](https://github.com/SixtoArrejin/chess-study)**, una herramienta web interactiva de pantalla dividida (*split-screen*) pensada para estudiantes de ajedrez. Sincroniza la lectura de libros en PDF con un tablero de análisis digital en tiempo real para evitar estar alternando pestañas mientras estudias.
